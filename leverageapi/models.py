...
class CacheValueAmount(Base):
    ...
    breakdown_1 = sa.Column(sa.String(32), nullable=False, server_default=sa.text("''"))
    breakdown_2 = sa.Column(sa.String(32), nullable=False, server_default=sa.text("''"))
    breakdown_3 = sa.Column(sa.String(32), nullable=False, server_default=sa.text("''"))
    ...
    """
    def get_object(self):
        if self.object_name == 'committee':
            return db_session.query(Committee).get(self.object_id)
    """
