...
def donations_by_state_house_district(committee_id):
    ...
    return render_template('state_house_map.html', api_url='/api/donations_by_state_house_district/{}'.format(committee_id))
...
ORDER BY percent_in_district DESC"""
    ...
    candidates_in_district_percent = db_session.execute(sql_query)
